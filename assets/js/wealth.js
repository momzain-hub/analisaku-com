/* Analisaku Wealth Management v1.9.2.4 bootstrap */
(function(){
  ...
  async function init(){
    ...
    try{
      ...
      await loadScript(url('wealth-pdf-download.js?v=1.9.2.4-20260916-1025'));
      ...
      setTimeout(()=>{
        ...
        if(badge)badge.textContent='WEALTH v1.9.2.4';
      },80);
    }catch(error){console.error('Wealth Management v1.9.2.4 gagal dimuat',error);}
  }
